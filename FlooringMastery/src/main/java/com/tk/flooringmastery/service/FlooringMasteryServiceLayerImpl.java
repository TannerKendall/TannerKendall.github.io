...
public class FlooringMasteryServiceLayerImpl implements FlooringMasteryServiceLayer {
    ...
    public FlooringMasteryServiceLayerImpl(FlooringMasteryOrderDao orderDao, FlooringMasteryTaxDao taxDao,
            FlooringMasteryProductDao productDao, FlooringMasteryAuditDao auditDao) throws FlooringMasteryPersistanceException {
    ...
    public List<Order> getAllOrdersByDate(LocalDate ordersDate) throws FlooringMasteryPersistanceException {
        ordersForDate = orderDao.getAllOrdersByDate(ordersDate);
        
        if(ordersForDate.isEmpty()){
            throw new FlooringMasteryPersistanceException("NO ORDERS FOR SELECTED DATE..");
        } else{
    ...
    public Order addOrder(int orderNum, Order order) throws FlooringMasteryPersistanceException, FlooringMasteryOrderValidationException {
        ...
        auditDao.writeAuditEntry("ORDER ADDED");
